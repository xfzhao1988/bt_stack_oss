...
/* Version 5.4  */
#define HCI_LE_SUP_FEAT_ADV_CODING_SELECTION                0x000001000000000  /*!<Advertising Coding Selection */
#define HCI_LE_SUP_FEAT_ADV_CODING_SELECTION_HOST_SUPPORT   0x000002000000000  /*!<Advertising Coding Selection (Host Support) */
#define HCI_LE_SUP_FEAT_PER_ADV_WITH_RESP_ADVERTISER        0x000004000000000  /*!<Periodic Advertising with Responses - Advertiser */
#define HCI_LE_SUP_FEAT_PER_ADV_WITH_RESP_SCANNER           0x000008000000000  /*!<Periodic Advertising with Responses - Scanner */
